## ── Builder stage ────────────────────────────────────────────────────────────
FROM python:3.15.0rc1-alpine3.23@sha256:af4dbb84b898095e33a0e18ed70be66e6df4f85740da1a2c266907f31e036075 AS builder
...
# Copy the frozen environment from the identical Python base image.  Keeping
# the same absolute path preserves console-script shebangs generated by uv.
