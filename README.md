...
| GitHub Action | `uses: msaad00/agent-bom@v0.38.1` |
...
| GitHub Action | `uses: msaad00/agent-bom@v0.38.1` | CI/CD + SARIF |
...
```yaml
- uses: msaad00/agent-bom@v0.38.1
  with:
...
- **Sigstore signed** — releases v0.7.0+ signed via cosign OIDC; verify PyPI integrity with `agent-bom verify agent-bom@0.38.1` (SHA-256 + SLSA provenance)
