...
| GitHub Action | `uses: msaad00/agent-bom@v0.53.0` |
...
| GitHub Action | `uses: msaad00/agent-bom@v0.53.0` | CI/CD + SARIF |
...
```yaml
- uses: msaad00/agent-bom@v0.53.0
  with:
...
- **Sigstore signed** — releases v0.7.0+ signed via cosign OIDC; verify PyPI integrity with `agent-bom verify agent-bom@0.53.0` (SHA-256 + SLSA provenance)
