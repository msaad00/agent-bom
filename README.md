...
| CI gate | `uses: msaad00/agent-bom@v0.87.0` | SARIF, PR summary, optional code-scanning upload |
...
MCP server mode advertises 41 read-only security tools, 6 resources, and 6 workflow prompts.
