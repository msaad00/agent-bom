...
BEGIN
  FOREACH t IN ARRAY ARRAY[
    ...
    'control_plane_sources','credential_refs','audit_chain_checkpoint','managed_trial_invitations','compliance_hub_findings','hub_findings_current',
...
SELECT component,1,now() FROM unnest(ARRAY[
 ...
 'shared_auth_state','managed_trial_invitations','governance_audit_log','ai_system_blueprints','mcp_client_configs','model_provider_keys','tenant_score_config'
]) component
