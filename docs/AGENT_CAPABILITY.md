...
<!-- Generated by scripts/generate_agent_capability_manifest.py on 2026-08-19 -->
...
| REST API | 392 operations across 47 route modules (+ 2 WebSocket routes) — see `docs/openapi/v1.json` |
