...
<!-- Generated by scripts/generate_agent_capability_manifest.py on 2026-07-24 -->
...
| REST API | 371 operations across 44 route modules (+ 2 WebSocket routes) — see `docs/openapi/v1.json` |
...
`0.98.0` — regenerate metrics with `python scripts/product_metrics_snapshot.py --write` and this file with `python scripts/generate_agent_capability_manifest.py --write`.
