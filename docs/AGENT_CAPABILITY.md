...
<!-- Generated by scripts/generate_agent_capability_manifest.py on 2026-07-29 -->
...
`0.98.2` — regenerate metrics with `python scripts/product_metrics_snapshot.py --write` and this file with `python scripts/generate_agent_capability_manifest.py --write`.
