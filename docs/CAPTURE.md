...
| `correlation-receipts-live.png` | `/security-graph?lens=attack-path&scan=reference-evidence-correlation-v1&correlation=1&capture=1` | Latest completed correlation selected automatically, with six friendly source receipts and an immutable manifest-bound result; custom creation stays collapsed | Primary README proof; generated from the reference lab rather than the synthetic graph fixture |
...
| `correlation-receipts-light-live.png` | `/security-graph?lens=attack-path&scan=reference-evidence-correlation-v1&correlation=1&capture=1` | Same automatic reference-lab journey and receipt DAG in the light theme | Theme readability contract; not a separate evidence run |
...
| `correlation-receipts-mobile-live.png` | `/security-graph?lens=attack-path&scan=reference-evidence-correlation-v1&correlation=1&capture=1` | Automatic reference-lab journey and receipt DAG at 390 by 844 without horizontal overflow | Mobile readability contract; not a separate evidence run |
| `correlation-path-mobile-live.png` | `/security-graph?lens=attack-path&scan=reference-evidence-correlation-v1&cve=CVE-2023-4863&capture=1` | Confirmed reference-lab path as readable sequential hops with inspectable evidence at 390 by 844 without horizontal overflow | Mobile readability contract; not a separate evidence run |
