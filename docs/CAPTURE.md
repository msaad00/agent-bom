...
| `correlation-path-mobile-live.png` | `/security-graph?lens=attack-path&scan=reference-evidence-correlation-v1&cve=CVE-2023-4863&capture=1` | Confirmed reference-lab path and inspectable hop evidence at 390 by 844 without horizontal overflow | Mobile readability contract; not a separate evidence run |
