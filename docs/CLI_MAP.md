...
| `attest` | Sign/verify tenant-bound SBOM DSSE PAE and per-instance MCP scan attestations (`attest mcp sign|verify`) with explicit Ed25519 trust policies; legacy embedded-key envelopes remain untrusted. |
