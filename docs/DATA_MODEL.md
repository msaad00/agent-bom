...
| `AIBOMReport` | 46 | `agents: list[Agent]`, `blast_radii: list[BlastRadius]`, `generated_at: datetime`, `scan_id: str`, `tool_version: str`, `executive_summary: Optional[str]`, `ai_threat_chains: list[str]`, `mcp_config_analysis: Optional[dict]`, `skill_audit_data: Optional[dict]`, `trust_assessment_data: Optional[dict]`, `prompt_scan_data: Optional[dict]`, `model_files: list[dict]`, `model_manifests: list[dict]`, `model_provenance: list[dict]`, `model_hash_verification_data: Optional[dict]`, `model_supply_chain_data: Optional[dict]`, `enforcement_data: Optional[dict]`, `context_graph_data: Optional[dict]`, `license_report: Optional[dict]`, `vex_data: Optional[dict]`, `toxic_combinations: Optional[list]`, `prioritized_findings: Optional[list]`, `sast_data: Optional[dict]`, `cis_benchmark_data: Optional[dict]`, `snowflake_cis_benchmark_data: Optional[dict]`, `azure_cis_benchmark_data: Optional[dict]`, `gcp_cis_benchmark_data: Optional[dict]`, `databricks_cis_benchmark_data: Optional[dict]`, `aisvs_benchmark_data: Optional[dict]`, `vector_db_scan_data: Optional[list]`, `gpu_infra_data: Optional[dict]`, `iac_findings_data: Optional[dict]`, `runtime_correlation: Optional[dict]`, `delta_data: Optional[dict]`, `scan_performance_data: Optional[dict]`, `training_pipelines: Optional[dict]`, `dataset_cards: Optional[dict]`, `serving_configs: Optional[list]`, `browser_extensions: Optional[dict]`, `ai_inventory_data: Optional[dict]`, `project_inventory_data: Optional[dict]`, `introspection_data: Optional[dict]`, `health_check_data: Optional[dict]`, `runtime_session_graph: Optional[dict]`, `findings: list['Finding']`, `scan_sources: list[str]` |
...
| `EntityType` | 32 | `agent`, `server`, `package`, `tool`, `tool_call`, `model`, `dataset`, `container`, `cloud_resource`, `resource`, `source_file`, `code_module`, `config_file`, `external_import`, `ci_job`, `vulnerability`, `misconfiguration`, `credential`, `credential_ref`, `org`, `account`, `user`, `group`, `role`, `policy`, `service_account`, `service_principal`, `federated_identity`, `provider`, `environment`, `fleet`, `cluster` |
| `RelationshipType` | 38 | `hosts`, `uses`, `depends_on`, `provides_tool`, `exposes_cred`, `reaches_tool`, `serves_model`, `contains`, `imports`, `defines`, `runs`, `configures`, `affects`, `vulnerable_to`, `exploitable_via`, `remediates`, `triggers`, `shares_server`, `shares_cred`, `lateral_path`, `manages`, `owns`, `part_of`, `member_of`, `assumes`, `trusts`, `attached`, `inherits`, `can_access`, `cross_account_trust`, `acted_as`, `invoked`, `called`, `used_credential`, `accessed`, `delegated_to`, `correlates_with`, `possibly_correlates_with` |
...
| `docs/openapi/v1.json` | paths | 213 |
