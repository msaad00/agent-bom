...
| `AIBOMReport` | 67 | `agents: list[Agent]`, `blast_radii: list[BlastRadius]`, `generated_at: datetime`, `scan_id: str`, `tool_version: str`, `executive_summary: Optional[str]`, `ai_threat_chains: list[str]`, `mcp_config_analysis: Optional[dict[str, Any]]`, `ai_enrichment_metadata: Optional[dict[str, Any]]`, `ai_finding_assessments: list[AIFindingAssessment]`, `skill_audit_data: Optional[dict[str, Any]]`, `trust_assessment_data: Optional[dict[str, Any]]`, `prompt_scan_data: Optional[dict[str, Any]]`, `model_files: list[dict[str, Any]]`, `model_manifests: list[dict[str, Any]]`, `model_provenance: list[dict[str, Any]]`, `model_hash_verification_data: Optional[dict[str, Any]]`, `model_supply_chain_data: Optional[dict[str, Any]]`, `enforcement_data: Optional[dict[str, Any]]`, `context_graph_data: Optional[dict[str, Any]]`, `license_report: Optional[dict[str, Any]]`, `vex_data: Optional[dict[str, Any]]`, `toxic_combinations: Optional[list[Any]]`, `prioritized_findings: Optional[list[Any]]`, `sast_data: Optional[dict[str, Any]]`, `aws_organization_data: Optional[dict[str, Any]]`, `cis_benchmark_data: Optional[dict[str, Any]]`, `snowflake_cis_benchmark_data: Optional[dict[str, Any]]`, `snowflake_object_graph_data: Optional[dict[str, Any]]`, `snowflake_login_anomalies_data: Optional[dict[str, Any]]`, `snowflake_exfil_graph_data: Optional[dict[str, Any]]`, `snowflake_auth_posture_data: Optional[dict[str, Any]]`, `snowflake_services_data: Optional[dict[str, Any]]`, `snowflake_pipeline_data: Optional[dict[str, Any]]`, `snowflake_integrations_data: Optional[dict[str, Any]]`, `snowflake_external_data_data: Optional[dict[str, Any]]`, `snowflake_governance_data: Optional[dict[str, Any]]`, `snowflake_activity_data: Optional[dict[str, Any]]`, `azure_cis_benchmark_data: Optional[dict[str, Any]]`, `gcp_cis_benchmark_data: Optional[dict[str, Any]]`, `databricks_cis_benchmark_data: Optional[dict[str, Any]]`, `aisvs_benchmark_data: Optional[dict[str, Any]]`, `vector_db_scan_data: Optional[list[Any]]`, `gpu_infra_data: Optional[dict[str, Any]]`, `iac_findings_data: Optional[dict[str, Any]]`, `toxic_combination_findings_data: Optional[list[Any]]`, `nhi_governance_findings: list['Finding']`, `ciem_over_privilege_findings_data: Optional[list[Any]]`, `cloud_inventory_data: Optional[Union[dict[str, Any], list[Any]]]`, `identity_discovery_data: Optional[dict[str, Any]]`, `cloud_audit_trail_data: Optional[Union[dict[str, Any], list[Any]]]`, `runtime_correlation: Optional[dict[str, Any]]`, `delta_data: Optional[dict[str, Any]]`, `scan_performance_data: Optional[dict[str, Any]]`, `vuln_data_freshness: Optional[dict[str, Any]]`, `training_pipelines: Optional[dict[str, Any]]`, `dataset_cards: Optional[dict[str, Any]]`, `serving_configs: Optional[list[Any]]`, `browser_extensions: Optional[dict[str, Any]]`, `ai_inventory_data: Optional[dict[str, Any]]`, `project_inventory_data: Optional[dict[str, Any]]`, `introspection_data: Optional[dict[str, Any]]`, `health_check_data: Optional[dict[str, Any]]`, `runtime_session_graph: Optional[dict[str, Any]]`, `findings: list['Finding']`, `scan_sources: list[str]`, `coverage_warnings: list[dict[str, Any]]` |
...
| `docs/openapi/v1.json` | paths | 307 |
| `docs/openapi/v1.json` | component schemas | 100 |
