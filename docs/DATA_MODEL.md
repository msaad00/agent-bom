...
|---|---:|---|
| `Vulnerability` | 34 | `id: str`, `summary: str`, `severity: Severity`, `severity_source: Optional[str]`, `confidence: float | None`, `cvss_score: Optional[float]`, `fixed_version: Optional[str]`, `references: list[str]`, `epss_score: Optional[float]`, `epss_percentile: Optional[float]`, `is_kev: bool`, `kev_date_added: Optional[str]`, `kev_due_date: Optional[str]`, `published_at: Optional[str]`, `modified_at: Optional[str]`, `nvd_published: Optional[str]`, `nvd_modified: Optional[str]`, `nvd_status: Optional[str]`, `cwe_ids: list[str]`, `aliases: list[str]`, `exploitability: Optional[str]`, `vex_status: Optional[str]`, `vex_justification: Optional[str]`, `compliance_tags: dict[str, list[str]]`, `advisory_sources: list[str]`, `match_confidence_tier: Optional[str]`, `cvss_vector: Optional[str]`, `attack_vector: Optional[str]`, `attack_complexity: Optional[str]`, `privileges_required: Optional[str]`, `user_interaction: Optional[str]`, `network_exploitable: bool`, `affected_symbols: list[str]`, `affected_symbols_by_path: dict[str, list[str]]` |
...
| `Package` | 52 | `name: str`, `version: str`, `ecosystem: str`, `purl: Optional[str]`, `source_package: Optional[str]`, `distro_name: Optional[str]`, `distro_version: Optional[str]`, `vulnerabilities: list[Vulnerability]`, `is_direct: bool`, `parent_package: Optional[str]`, `dependency_depth: int`, `dependency_scope: str`, `reachability_evidence: str`, `resolved_from_registry: bool`, `registry_version: Optional[str]`, `version_source: str`, `declared_version: Optional[str]`, `resolved_version: Optional[str]`, `version_confidence: Optional[str]`, `version_resolved_at: Optional[str]`, `version_evidence: list[dict[str, Any]]`, `version_conflicts: list[dict[str, Any]]`, `floating_reference: bool`, `floating_reference_reason: Optional[str]`, `is_malicious: bool`, `malicious_reason: Optional[str]`, `license: Optional[str]`, `license_expression: Optional[str]`, `deps_dev_resolved: bool`, `supplier: Optional[str]`, `author: Optional[str]`, `description: Optional[str]`, `homepage: Optional[str]`, `repository_url: Optional[str]`, `download_url: Optional[str]`, `copyright_text: Optional[str]`, `scorecard_score: Optional[float]`, `scorecard_checks: dict[str, int]`, `scorecard_repo: Optional[str]`, `scorecard_lookup_state: Optional[str]`, `scorecard_lookup_reason: Optional[str]`, `checksums: dict[str, str]`, `integrity_verified: Optional[bool]`, `provenance_attested: Optional[bool]`, `provenance_source: Optional[str]`, `provenance_status: Optional[str]`, `auto_risk_level: Optional[str]`, `auto_risk_justification: Optional[str]`, `maintainer_count: Optional[int]`, `source_repo: Optional[str]`, `occurrences: list[PackageOccurrence]`, `discovery_provenance: Optional[dict[str, Any]]` |
| `MCPTool` | 9 | `name: str`, `description: str`, `discovery_source: Optional[str]`, `discovery_confidence: Optional[str]`, `input_schema: Optional[dict[str, Any]]`, `declared_capabilities: list[str]`, `schema_findings: list[str]`, `schema_rule_findings: list[dict[str, Any]]`, `server_canonical_id: Optional[str]` |
| `MCPResource` | 6 | `uri: str`, `name: str`, `description: str`, `mime_type: Optional[str]`, `content_findings: list[str]`, `server_canonical_id: Optional[str]` |
...
| `MCPServer` | 23 | `name: str`, `command: str`, `args: list[str]`, `env: dict[str, str]`, `transport: TransportType`, `url: Optional[str]`, `tools: list[MCPTool]`, `resources: list[MCPResource]`, `prompts: list[MCPPrompt]`, `packages: list[Package]`, `config_path: Optional[str]`, `working_dir: Optional[str]`, `mcp_version: Optional[str]`, `registry_verified: bool`, `registry_id: Optional[str]`, `permission_profile: Optional[PermissionProfile]`, `security_blocked: bool`, `security_warnings: list[str]`, `security_intelligence: list[dict[str, object]]`, `surface: ServerSurface`, `discovery_sources: list[str]`, `discovery_provenance: Optional[dict[str, Any]]`, `identity_bindings: list[CredentialIdentityBinding]` |
| `Agent` | 16 | `name: str`, `agent_type: AgentType`, `config_path: str`, `mcp_servers: list[MCPServer]`, `version: Optional[str]`, `source: Optional[str]`, `status: AgentStatus`, `discovered_at: str`, `last_seen: Optional[str]`, `parent_agent: Optional[str]`, `metadata: dict[str, object]`, `automation_settings: list[Any]`, `discovery_provenance: Optional[dict[str, Any]]`, `discovery_envelope: Optional[dict[str, Any]]`, `source_id: Optional[str]`, `device_fingerprint: Optional[str]` |
| `BlastRadius` | 50 | `vulnerability: Vulnerability`, `package: Package`, `affected_servers: list[MCPServer]`, `affected_agents: list[Agent]`, `exposed_credentials: list[str]`, `exposed_tools: list[MCPTool]`, `phantom_tools: list[MCPTool]`, `risk_score: float`, `ai_risk_context: Optional[str]`, `owasp_tags: list[str]`, `atlas_tags: list[str]`, `attack_tags: list[str]`, `nist_ai_rmf_tags: list[str]`, `owasp_mcp_tags: list[str]`, `owasp_agentic_tags: list[str]`, `eu_ai_act_tags: list[str]`, `nist_csf_tags: list[str]`, `iso_27001_tags: list[str]`, `soc2_tags: list[str]`, `cis_tags: list[str]`, `cmmc_tags: list[str]`, `nist_800_53_tags: list[str]`, `fedramp_tags: list[str]`, `pci_dss_tags: list[str]`, `ai_summary: Optional[str]`, `suppressed: bool`, `suppression_id: Optional[str]`, `suppression_state: Optional[str]`, `suppression_reason: Optional[str]`, `unsuppressed_risk_score: Optional[float]`, `impact_category: str`, `all_server_credentials: list[str]`, `all_server_tools: list[MCPTool]`, `attack_vector_summary: Optional[str]`, `hop_depth: int`, `delegation_chain: list[str]`, `transitive_agents: list[dict[str, Any]]`, `transitive_credentials: list[str]`, `transitive_risk_score: float`, `graph_reachable: Optional[bool]`, `graph_min_hop_distance: Optional[int]`, `graph_reachable_from_agents: list[str]`, `symbol_reachability: Optional[str]`, `reachable_affected_symbols: list[str]`, `symbol_reachability_reason: Optional[str]`, `runtime_dependency_chain: list[str]`, `dependency_reachable: Optional[bool]`, `dependency_min_hop_distance: Optional[int]`, `dependency_reachable_from_agents: list[str]`, `symbol_reachability_tainted_argument: Optional[bool]` |
| `AIBOMReport` | 71 | `agents: list[Agent]`, `blast_radii: list[BlastRadius]`, `generated_at: datetime`, `scan_id: str`, `tool_version: str`, `executive_summary: Optional[str]`, `ai_threat_chains: list[str]`, `mcp_config_analysis: Optional[dict[str, Any]]`, `ai_enrichment_metadata: Optional[dict[str, Any]]`, `ai_finding_assessments: list[AIFindingAssessment]`, `skill_audit_data: Optional[dict[str, Any]]`, `trust_assessment_data: Optional[dict[str, Any]]`, `prompt_scan_data: Optional[dict[str, Any]]`, `model_files: list[dict[str, Any]]`, `model_manifests: list[dict[str, Any]]`, `model_provenance: list[dict[str, Any]]`, `model_hash_verification_data: Optional[dict[str, Any]]`, `model_supply_chain_data: Optional[dict[str, Any]]`, `enforcement_data: Optional[dict[str, Any]]`, `context_graph_data: Optional[dict[str, Any]]`, `license_report: Optional[dict[str, Any]]`, `vex_data: Optional[dict[str, Any]]`, `toxic_combinations: Optional[list[Any]]`, `prioritized_findings: Optional[list[Any]]`, `sast_data: Optional[dict[str, Any]]`, `aws_organization_data: Optional[dict[str, Any]]`, `cis_benchmark_data: Optional[dict[str, Any]]`, `snowflake_cis_benchmark_data: Optional[dict[str, Any]]`, `snowflake_object_graph_data: Optional[dict[str, Any]]`, `snowflake_login_anomalies_data: Optional[dict[str, Any]]`, `snowflake_exfil_graph_data: Optional[dict[str, Any]]`, `snowflake_auth_posture_data: Optional[dict[str, Any]]`, `snowflake_services_data: Optional[dict[str, Any]]`, `snowflake_pipeline_data: Optional[dict[str, Any]]`, `snowflake_integrations_data: Optional[dict[str, Any]]`, `snowflake_external_data_data: Optional[dict[str, Any]]`, `snowflake_governance_data: Optional[dict[str, Any]]`, `snowflake_activity_data: Optional[dict[str, Any]]`, `azure_cis_benchmark_data: Optional[dict[str, Any]]`, `gcp_cis_benchmark_data: Optional[dict[str, Any]]`, `databricks_security_data: Optional[dict[str, Any]]`, `aisvs_benchmark_data: Optional[dict[str, Any]]`, `vector_db_scan_data: Optional[list[Any]]`, `gpu_infra_data: Optional[dict[str, Any]]`, `iac_findings_data: Optional[dict[str, Any]]`, `toxic_combination_findings_data: Optional[list[Any]]`, `nhi_governance_findings: list['Finding']`, `ciem_over_privilege_findings_data: Optional[list[Any]]`, `cloud_inventory_data: Optional[Union[dict[str, Any], list[Any]]]`, `identity_discovery_data: Optional[dict[str, Any]]`, `cloud_audit_trail_data: Optional[Union[dict[str, Any], list[Any]]]`, `runtime_correlation: Optional[dict[str, Any]]`, `delta_data: Optional[dict[str, Any]]`, `scan_performance_data: Optional[dict[str, Any]]`, `vuln_data_freshness: Optional[dict[str, Any]]`, `training_pipelines: Optional[dict[str, Any]]`, `dataset_cards: Optional[dict[str, Any]]`, `serving_configs: Optional[list[Any]]`, `browser_extensions: Optional[dict[str, Any]]`, `endpoint_inventory_data: Optional[dict[str, Any]]`, `ai_inventory_data: Optional[dict[str, Any]]`, `project_inventory_data: Optional[dict[str, Any]]`, `repo_trust_data: Optional[dict[str, Any]]`, `codeowners: Union[list[dict[str, Any]], dict[str, str]]`, `introspection_data: Optional[dict[str, Any]]`, `health_check_data: Optional[dict[str, Any]]`, `runtime_session_graph: Optional[dict[str, Any]]`, `findings: list['Finding']`, `scan_sources: list[str]`, `scan_run: ScanRun`, `coverage_warnings: list[dict[str, Any]]` |
...
| `EntityType` | 42 | `agent`, `server`, `package`, `tool`, `tool_call`, `model`, `dataset`, `framework`, `container`, `cloud_resource`, `resource`, `source_file`, `code_module`, `config_file`, `external_import`, `ci_job`, `directory`, `vulnerability`, `misconfiguration`, `credential`, `credential_ref`, `org`, `account`, `user`, `group`, `role`, `policy`, `service_account`, `service_principal`, `federated_identity`, `managed_identity`, `access_grant`, `access_policy`, `blueprint`, `drift_incident`, `data_store`, `api_gateway`, `application`, `provider`, `environment`, `fleet`, `cluster` |
...
| `docs/openapi/v1.json` | paths | 345 |
| `docs/openapi/v1.json` | component schemas | 175 |
...
| `graph_nodes`, `graph_edges`, `graph_snapshots`, `attack_paths`, `interaction_risks`, `graph_filter_presets` | `UnifiedGraph` family | per-scan observed snapshots + delta alerts |
| `graph_scenarios` | snapshot-pinned proposed graph delta | tenant-scoped architecture comparison; never observed scan evidence |
...
| `runtime.blueprints.v1` | `GET /v1/runtime/blueprints`, `runtime_blueprints` MCP tool | admins, runtime policy authors, drift evaluator, docs | role/profile blueprint list with `allowed_tool_categories`, `restricted_tool_categories`, `approval_required_for`, `retention_mode`, `evidence_required` | Static canonical catalog in `runtime_blueprints.py`; these role archetypes seed the persisted `governance.blueprints.v1` entity. |
| `governance.blueprints.v1` | `GET/POST /v1/governance/blueprints` (+ `/seed`, `/{id}`, `/{id}/versions`, `/{id}/versions/{v}/{submit,approve,reject}`, `/{id}/diff`) | governance owners, approvers, graph overlay, drift evaluator | persisted blueprint header (`name`, `owner`, `current_version`, `latest_version`, `approval_status`) plus immutable `versions`, each snapshotting the composed `agents`/`models`/`tools`/`datasets`/`identities`/`owners`/`guardrails` with approval state (`draft`→`pending`→`approved`/`rejected`), mandatory `approver`, and `decided_at` | Durable, tenant-scoped store (`blueprint_store` — in-memory / SQLite / Postgres with tenant RLS). Seeded from the runtime role archetypes; reading is viewer-allowed, authoring is a contributor action, approval requires the admin role. Approved versions are immutable. Resolving a drift incident with an `accept_drift` disposition promotes the observed drift into a **new draft version submitted for approval** (draft→pending) — accepting drift is never auto-approved (#3905). |
| `graph.scenarios.v1` / `graph.scenario-comparison.v1` | `/v1/graph/scenarios` CRUD + `/{scenario_id}/comparison` | architects and security operators comparing current and proposed topology | exact `base_scan_id`, bounded typed changes, assumptions, author/revision, separate observed and modeled counts, inherited completeness, and touched observed path IDs | Durable tenant-scoped SQLite/Postgres state with Postgres RLS. A scenario is a proposed delta, not a second observed graph. Added nodes and edges carry `evidence_state=proposed`, `observed=false`, and `deployed=false`; comparison never mutates `graph_nodes`, `graph_edges`, findings, SARIF, or attack-path evidence. A missing or mismatched base snapshot is unavailable rather than silently rebased. |
| `runtime.blueprint_drift.v1` | `GET /v1/runtime/blueprints/{blueprint_id}/drift`, `runtime_blueprint_drift` MCP tool | runtime operators, agents, alerting, release evidence | `status`, `drift_score`, `observed.categories`, `violations`, `warnings`, selected `blueprint`, `retention` | Compares the selected blueprint against the tenant-scoped production index. Current behavior is report-only and fail-closed to metadata retention. Resolving the resulting incident (`POST /v1/runtime/drift/incidents/{id}/resolve`) accepts `{disposition, blueprint_id?}`; an accept disposition re-enters the blueprint approval workflow. |
| `observability.costs.v1` (budgets) | `GET/PUT /v1/observability/costs/budget`, `GET /v1/observability/costs` | FinOps owners, accountable owners, gateway enforcement | `CostBudget` scopes to tenant / `agent` / `cost_center` / `owner` (+ `workflow`); the costs report adds a `by_owner` rollup | Owner spend joins to the accountable owner on the governing blueprint header (`cost_owner`); enforced pre-invocation at the gateway (`budget_scope: "owner"`). Durable dual-backend store with tenant RLS; scopes are mutually exclusive (#3909). |
