...
| `MCPTool` | 9 | `name: str`, `description: str`, `discovery_source: Optional[str]`, `discovery_confidence: Optional[str]`, `input_schema: Optional[dict]`, `declared_capabilities: list[str]`, `schema_findings: list[str]`, `schema_rule_findings: list[dict]`, `server_canonical_id: Optional[str]` |
...
| `BlastRadius` | 44 | `vulnerability: Vulnerability`, `package: Package`, `affected_servers: list[MCPServer]`, `affected_agents: list[Agent]`, `exposed_credentials: list[str]`, `exposed_tools: list[MCPTool]`, `phantom_tools: list[MCPTool]`, `risk_score: float`, `ai_risk_context: Optional[str]`, `owasp_tags: list[str]`, `atlas_tags: list[str]`, `attack_tags: list[str]`, `nist_ai_rmf_tags: list[str]`, `owasp_mcp_tags: list[str]`, `owasp_agentic_tags: list[str]`, `eu_ai_act_tags: list[str]`, `nist_csf_tags: list[str]`, `iso_27001_tags: list[str]`, `soc2_tags: list[str]`, `cis_tags: list[str]`, `cmmc_tags: list[str]`, `nist_800_53_tags: list[str]`, `fedramp_tags: list[str]`, `pci_dss_tags: list[str]`, `ai_summary: Optional[str]`, `suppressed: bool`, `suppression_id: Optional[str]`, `suppression_state: Optional[str]`, `suppression_reason: Optional[str]`, `unsuppressed_risk_score: Optional[float]`, `impact_category: str`, `all_server_credentials: list[str]`, `all_server_tools: list[MCPTool]`, `attack_vector_summary: Optional[str]`, `hop_depth: int`, `delegation_chain: list[str]`, `transitive_agents: list[dict]`, `transitive_credentials: list[str]`, `transitive_risk_score: float`, `graph_reachable: Optional[bool]`, `graph_min_hop_distance: Optional[int]`, `graph_reachable_from_agents: list[str]`, `symbol_reachability: Optional[str]`, `reachable_affected_symbols: list[str]` |
| `AIBOMReport` | 67 | `agents: list[Agent]`, `blast_radii: list[BlastRadius]`, `generated_at: datetime`, `scan_id: str`, `tool_version: str`, `executive_summary: Optional[str]`, `ai_threat_chains: list[str]`, `mcp_config_analysis: Optional[dict]`, `ai_enrichment_metadata: Optional[dict]`, `ai_finding_assessments: list[AIFindingAssessment]`, `skill_audit_data: Optional[dict]`, `trust_assessment_data: Optional[dict]`, `prompt_scan_data: Optional[dict]`, `model_files: list[dict]`, `model_manifests: list[dict]`, `model_provenance: list[dict]`, `model_hash_verification_data: Optional[dict]`, `model_supply_chain_data: Optional[dict]`, `enforcement_data: Optional[dict]`, `context_graph_data: Optional[dict]`, `license_report: Optional[dict]`, `vex_data: Optional[dict]`, `toxic_combinations: Optional[list]`, `prioritized_findings: Optional[list]`, `sast_data: Optional[dict]`, `aws_organization_data: Optional[dict]`, `cis_benchmark_data: Optional[dict]`, `snowflake_cis_benchmark_data: Optional[dict]`, `snowflake_object_graph_data: Optional[dict]`, `snowflake_login_anomalies_data: Optional[dict]`, `snowflake_exfil_graph_data: Optional[dict]`, `snowflake_auth_posture_data: Optional[dict]`, `snowflake_services_data: Optional[dict]`, `snowflake_pipeline_data: Optional[dict]`, `snowflake_integrations_data: Optional[dict]`, `snowflake_external_data_data: Optional[dict]`, `snowflake_governance_data: Optional[dict]`, `snowflake_activity_data: Optional[dict]`, `azure_cis_benchmark_data: Optional[dict]`, `gcp_cis_benchmark_data: Optional[dict]`, `databricks_cis_benchmark_data: Optional[dict]`, `aisvs_benchmark_data: Optional[dict]`, `vector_db_scan_data: Optional[list]`, `gpu_infra_data: Optional[dict]`, `iac_findings_data: Optional[dict]`, `toxic_combination_findings_data: Optional[list]`, `nhi_governance_findings: list['Finding']`, `ciem_over_privilege_findings_data: Optional[list]`, `cloud_inventory_data: Optional[Union[dict, list]]`, `identity_discovery_data: Optional[dict]`, `cloud_audit_trail_data: Optional[Union[dict, list]]`, `runtime_correlation: Optional[dict]`, `delta_data: Optional[dict]`, `scan_performance_data: Optional[dict]`, `vuln_data_freshness: Optional[dict]`, `training_pipelines: Optional[dict]`, `dataset_cards: Optional[dict]`, `serving_configs: Optional[list]`, `browser_extensions: Optional[dict]`, `ai_inventory_data: Optional[dict]`, `project_inventory_data: Optional[dict]`, `introspection_data: Optional[dict]`, `health_check_data: Optional[dict]`, `runtime_session_graph: Optional[dict]`, `findings: list['Finding']`, `scan_sources: list[str]`, `coverage_warnings: list[dict]` |
