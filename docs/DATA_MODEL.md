...
|---|---:|---|
| `Vulnerability` | 31 | `id: str`, `summary: str`, `severity: Severity`, `severity_source: Optional[str]`, `confidence: float | None`, `cvss_score: Optional[float]`, `fixed_version: Optional[str]`, `references: list[str]`, `epss_score: Optional[float]`, `epss_percentile: Optional[float]`, `is_kev: bool`, `kev_date_added: Optional[str]`, `kev_due_date: Optional[str]`, `published_at: Optional[str]`, `modified_at: Optional[str]`, `nvd_published: Optional[str]`, `nvd_modified: Optional[str]`, `nvd_status: Optional[str]`, `cwe_ids: list[str]`, `aliases: list[str]`, `exploitability: Optional[str]`, `vex_status: Optional[str]`, `vex_justification: Optional[str]`, `compliance_tags: dict[str, list[str]]`, `advisory_sources: list[str]`, `cvss_vector: Optional[str]`, `attack_vector: Optional[str]`, `attack_complexity: Optional[str]`, `privileges_required: Optional[str]`, `user_interaction: Optional[str]`, `network_exploitable: bool` |
