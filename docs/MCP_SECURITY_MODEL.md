...
Exposes 8 tools by default, or the explicit 86-tool `--profile full` catalog, to AI assistants that negotiate the verified session-era
...
registry_lookup     — search 1133 MCP servers by name/tag
