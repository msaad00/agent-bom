...
| Agent interface | 8 default tools; explicit full catalog of 86 MCP tools, strict arguments, `exposure_paths`, `graph_correlate`, threat-intel lookup, runtime posture, admin-gated write actions | long-lived posture subscription tool, autonomous remediation actions |
