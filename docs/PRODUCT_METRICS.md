...
| --- | ---: | --- | --- |
| MCP tools | 84 | `src/agent_bom/mcp_server_metadata.py` | Counted from the advertised server-card tools. |
...
| Python modules | 869 | `src/agent_bom` | Counts all Python files recursively. |
