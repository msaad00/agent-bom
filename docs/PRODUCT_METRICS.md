...
| Test files | 689 | `tests/` | Counts files matching test_*.py. |
| API route modules | 33 | `src/agent_bom/api/routes` | Counts Python files in the routes package, including __init__.py. |
| UI app pages | 30 | `ui/app` | Counts page.tsx and page.jsx files recursively. |
| Python modules | 610 | `src/agent_bom` | Counts all Python files recursively. |
