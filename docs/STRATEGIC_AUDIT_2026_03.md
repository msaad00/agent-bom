...
| **protect** | 7 detectors: ToolDrift (rug pull), ArgumentAnalyzer (injection), CredentialLeak, SequenceAnalyzer (exfil patterns), ResponseInspector (cloaking/SVG/invisible chars), VectorDBInjectionDetector, CrossAgentCorrelator |
