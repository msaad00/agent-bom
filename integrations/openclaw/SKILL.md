...
```bash
docker run --rm ghcr.io/msaad00/agent-bom:0.38.0 scan
```
...
- **Sigstore signed**: `agent-bom verify agent-bom@0.38.0`
- **2,040 tests** with automated security scanning (CodeQL + OpenSSF Scorecard)
