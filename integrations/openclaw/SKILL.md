...
metadata:
  ...
  install:
    pipx: agent-bom
    pip: agent-bom
    docker: ghcr.io/msaad00/agent-bom:0.98.3
  openclaw:
    requires:
      bins: []
      env: []
    ...
    data_flow: >-
      ...
      compliance tags, and SBOM data. Registry lookups (1059 MCP servers) are
...
- **Sigstore signed**: `agent-bom verify agent-bom@0.98.3`
