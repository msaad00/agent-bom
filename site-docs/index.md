<p align="center">
  <picture>
    ...
    <img src="https://raw.githubusercontent.com/msaad00/agent-bom/main/docs/images/brand/logo-light.svg" alt="agent-bom" width="380">
  </picture>
</p>
...
| **CI evidence** | `uses: msaad00/agent-bom@v0.103.2` | SARIF, pull-request summary, optional code scanning |
...
| **MCP tools** | AI agents and coding assistants | 8 default tools; explicit full catalog of 86 tools, strict args, `exposure_paths`, `graph_correlate`, runtime posture, audited write actions |
...
then use `agent-bom cloud aws --cis`, `agent-bom cloud azure --cis`, or
`agent-bom cloud gcp --cis` to verify runtime state after drift and inherited
provider settings exist. Snowflake uses
...
| **Registry** | 1123 MCP server security metadata entries |
