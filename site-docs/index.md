...
| **CI evidence** | `uses: msaad00/agent-bom@v0.103.0` | SARIF, pull-request summary, optional code scanning |
...
| **MCP tools** | AI agents and coding assistants | 84 tools, strict args, `exposure_paths`, `should_i_deploy`, runtime posture, audited write actions |
