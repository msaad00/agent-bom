"""Tree-sitter JS/TS engine: parses source blocks into structured analysis.

Provides a small, focused AST layer for JavaScript and TypeScript code
blocks used in skills and first-party SAST rules. It starts with
import/require resolution plus call-site collection so higher layers can
reason about dangerous capabilities using real syntax trees instead of
regexes. Import through :mod:`agent_bom.ast.js_ts`, not this module.
"""
