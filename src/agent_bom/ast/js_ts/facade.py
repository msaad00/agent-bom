"""JS/TS file scanning facade: regex signals plus tree-sitter engine calls.

Degrades gracefully to regex-only signals when the tree-sitter runtime is
unavailable. Import through :mod:`agent_bom.ast.js_ts`, not this module.
"""
...
def scan_js_ts_file(
    ...
    try:
        from agent_bom.ast.js_ts.engine import JSImportRef, JSTSAstUnavailableError, JSTSToolRegistration, analyze_js_ts_block
