...
def emit_dry_run_plan(
    ...
    *,
    ...
    con.print("    • Credential words: KEY, TOKEN, SECRET, PASSWORD, CREDENTIAL, AUTHORIZATION")
    con.print("    • Credential-shaped names: DATABASE_URL, CONN_STR, CA_CERT, CLIENT_CERTIFICATE")
    con.print("    • AUTH_MODE, CERTIFICATE_PATH, DB_CONNECTION_POOL_SIZE, and KEYBOARD_LAYOUT are not credentials")
