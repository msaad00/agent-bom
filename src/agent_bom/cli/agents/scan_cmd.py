...
Implementation module for ``agent_bom.cli.agents``. Patch targets
(``discover_all``, ``extract_packages``, etc.) are bound on
...
def scan(
    ...
    run_cloud_discovery(
        ...
        aws_include_lambda=not no_aws_lambda,
        aws_include_eks=aws_include_eks,
        aws_include_step_functions=aws_include_step_functions,
        aws_include_ec2=aws_include_ec2,
        aws_include_iam=aws_include_iam,
        ...
        if no_scan:
            ...
            if not quiet:
                ...
                with (
                    ...
                    try:
                        blast_radii = _agents_patchable("scan_agents_sync")(
                            agents,
