...
_PROFILES: tuple[ProviderResilienceProfile, ...] = (
    ProviderResilienceProfile(
        ...
        max_page_safety="SDK paginator exhaustion; 10k synthetic provider proof remains outstanding",
    ...
    ProviderResilienceProfile(
        provider="openai",
        surface="OpenAI assistants and completed fine-tuning jobs with referenced training-file IDs",
        ...
        max_page_safety="bounded 100-page loops; multi-page 10k completeness proof remains outstanding",
        synthetic_scale_target=10_000,
        status="partial",
    ...
    ProviderResilienceProfile(
        ...
        max_page_safety="page-token exhaustion; multi-page 10k completeness proof remains outstanding",
        synthetic_scale_target=10_000,
        status="partial",
