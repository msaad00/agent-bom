...
# Role granted when unauthenticated API access is explicitly enabled (default viewer).
NO_AUTH_ROLE = os.environ.get("AGENT_BOM_NO_AUTH_ROLE", "viewer").strip().lower()
