...
Resources (6):
    registry://servers  — Browse the 1142-entry server security metadata registry
...
def create_mcp_server(
    *,
    ...
    async def exposure_paths(
        ...
        cursor: Annotated[str | None, Field(max_length=4096, description="Continue with pagination.next_cursor; keep the risk filter unchanged.")] = None,
    ) -> str:
