...
def _blast_radius_json_entry(
    ...
    return {
        ...
        **effective_blast_radius_tags(br),
        ...
        "dependency_reachable_from_agents": getattr(br, "dependency_reachable_from_agents", []),
        "graph_reachable": getattr(br, "graph_reachable", None),
        ...
        "symbol_reachability_tainted_argument": getattr(br, "symbol_reachability_tainted_argument", None),
