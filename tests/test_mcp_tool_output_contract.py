...
def _minimal_args(name: str, workdir: Path) -> dict[str, Any]:
    ...
    per_tool: dict[str, dict[str, Any]] = {
        ...
        "graph_correlate": {
            ...
            "max_age_hours": 168,
            "idempotency_key": "output-contract-graph-correlation",
            "reason": "exercise structured output contract",
        },
        "graph_correlation_status": {"correlation_id": "correlation-does-not-exist"},
