    ...
    <div className="min-h-full bg-slate-50 px-8 py-7 text-slate-950">
      <div className="mx-auto max-w-[1560px]">
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-3">
          <EvidenceCard title="Bounded by default" body="Lower-priority nodes stay hidden until an operator expands filters, keeping the first pass focused instead of rendering the whole tenant." />
