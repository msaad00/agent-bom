...
function RemediationPage() {
  ...
  const normalizedCveParam = cveParam.toLowerCase();
  ...
  const displayed = useMemo(() => {
    ...
    const evidenceQuery = queryParam || normalizedCveParam || packageParam;
    if (evidenceQuery) {
    ...
    return list;
  }, [items, queryParam, normalizedCveParam, packageParam, severityFilter, frameworkFilter, fixableOnly, sortKey, sortDir]);
