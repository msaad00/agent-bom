...
export const ContextEvidenceEdge = memo(function ContextEvidenceEdge({
  ...
  return <>
    ...
    {typeof label === "string" && <EdgeLabelRenderer>
      <button type="button" className="nodrag nopan absolute whitespace-nowrap border border-[var(--border-strong)] bg-[var(--surface-metric)] px-2 py-1 font-semibold text-[var(--foreground)] shadow-sm"
