...
export function DemoEstateLabel() {
  ...
  return (
    <Link
      ...
      className={`z-[120] truncate rounded-full border border-emerald-500/40 bg-[color:var(--surface-elevated)]/95 px-3 py-1 font-medium uppercase tracking-[0.1em] text-emerald-700 shadow-md shadow-black/20 transition hover:border-emerald-500/70 hover:text-emerald-800 dark:text-emerald-200 dark:hover:text-emerald-100 ${
