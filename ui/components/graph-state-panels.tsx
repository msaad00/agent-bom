...
export function GraphControlGroup({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <span className="text-[10px] uppercase tracking-[0.2em] text-ink-tertiary">{label}</span>
...
export function GraphFindingsFallback({
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <div className="border-b border-outline bg-surface-muted px-4 py-3">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <p className="text-[10px] uppercase tracking-[0.2em] text-orange-400">Findings scope</p>
            <h3 className="mt-1 text-sm font-semibold text-foreground">This filter currently resolves to findings only</h3>
          ...
          <div className="rounded-xl border border-outline bg-surface-elevated px-3 py-2 text-xs text-ink-secondary">
...
function FindingRow({
  ...
  return (
    <div className="grid gap-3 border-b border-outline px-4 py-3 last:border-b-0 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
      <div className="min-w-0">
        <div className="flex min-w-0 flex-wrap items-center gap-2">
          ...
          <h4 className="truncate font-mono text-sm font-semibold text-foreground">{data.label}</h4>
        </div>
      ...
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className="rounded-lg border border-outline bg-surface-elevated px-3 py-1.5 text-xs font-medium text-foreground transition hover:border-outline-strong"
        >
          Open evidence
        </button>
        <Link
        ...
        {osvUrl && (
          <a
            ...
            className="inline-flex items-center gap-1 rounded-lg border border-outline px-3 py-1.5 text-xs font-medium text-ink-secondary transition-colors hover:border-outline-strong hover:text-foreground"
          >
            OSV
