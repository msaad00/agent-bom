  ...
  await page.route("**/v1/activity**", (route) =>
    route.fulfill({
      json: {
        ...
        events: [
          {
            observed_at: "2026-07-26T16:59:30Z",
            source: "runtime",
            ...
            trace_id: "trace-runtime-browser",
          },
        ],
        // Snowflake rides along under its own source entry, so the warehouse
        // views still render when a warehouse is actually connected.
        sources: [
          { source: "runtime", status: "active", event_count: 1, detail: "" },
          {
            source: "snowflake",
            status: "active",
            event_count: 1,
