    ...
    route.fulfill({
      json: {
        ...
        facets: {
          ...
          reachability: { reachable: 1, unreachable: 0, unassessed: 0 },
          exploit_intelligence: { kev_and_epss: 1, kev_only: 0, epss_only: 0, unavailable: 0 },
          fixability: { fix_available: 1, no_fix_available: 0 },
          ownership: { owned: 1, unowned: 0 },
          disposition: { affected: 0, not_affected: 1, under_investigation: 0, untriaged: 0 },
        },
